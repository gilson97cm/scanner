import { PointPositionChange, LimitsService } from './../../services/limits.service';
import { ImageDimensions } from './../../PublicModels';
import { AfterViewInit, Component, Input, ViewChild, ElementRef } from '@angular/core';


@Component({
  selector: 'app-shape-outline',
  templateUrl: './shape-outline.component.html',
  styleUrls: ['./shape-outline.component.scss']
})
export class ShapeOutlineComponent implements AfterViewInit {


  @Input() color = '#3cabe2';
  @Input() weight: number = 0;
  @Input() dimensions: ImageDimensions = { width: 0, height: 0 };
  @ViewChild('outline')
