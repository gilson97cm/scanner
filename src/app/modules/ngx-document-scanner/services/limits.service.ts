...
export class LimitsService {
   ...
   */
  private _paneDimensions: ImageDimensions = { width: 0, height: 0 };
   ...
   */
  public repositionPoints(positions:any) {
   ...
   */
  public rotateClockwise(resizeRatios:any, initialPreviewDimensions:any, initialPositions: Array<PointPositionChange>) {
    let r = resizeRatios
  ...
  private getDirectionAxis(direction: keyof IDirections): keyof XY {
    const key: keyof IDirections = direction
